  ...
  <div 
    ...
    <div v-else-if="supportsPreview">
      ...
      <vs-button 
        ...
        @click.prevent="selectImage">{{ strings.change }}</vs-button>
      <vs-button 
        v-if="imageSelected && removable" 
        @click.prevent="removeImage">{{ strings.remove }}</vs-button>
      <vs-button 
        v-if="imageSelected && toggleAspectRatio && width !== height"
        @click.prevent="rotateImage">{{ strings.aspect }}</vs-button>
    </div>
    <div v-else>
      <vs-button 
        v-if="!imageSelected" 
         
        @click.prevent="selectImage">{{ strings.select }}</vs-button>
      <div v-else>
